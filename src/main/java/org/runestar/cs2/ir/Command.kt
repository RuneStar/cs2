...
interface Command {
    ...
    enum class Basic(
        ...
        _7011(listOf(INT, INT, INT), listOf()),
        _7012(listOf(INT, INT, INT), listOf()),
        _7013(listOf(INT, INT), listOf()),
        ...
        _7021(listOf(INT, INT, INT), listOf()),
        _7022(listOf(INT, INT, INT), listOf()),
        _7023(listOf(INT, INT), listOf()),
        ...
        _7036(listOf(INT, INT), listOf()),
        _7037(listOf(INT, INT), listOf()),
        _7038(listOf(INT), listOf()),

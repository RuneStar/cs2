...
interface Command {
    ...
    enum class Basic(
        ...
        _3181(listOf(INT), listOf()),
        _3182(listOf(), listOf(INT)),
        _3183(listOf(INT), listOf()),
        ...
        _3203(listOf(INT), listOf()),
        _3204(listOf(), listOf(INT)),
        _3205(listOf(INT), listOf()),
        _3206(listOf(), listOf(INT)),
        _3207(listOf(INT), listOf()),
        _3208(listOf(), listOf(INT)),
        ...
        _5024(listOf(INT), listOf()),
        _5025(listOf(), listOf(INT)),
        ...
        _6753(listOf(), listOf(INT)),
        NC_NAME(listOf(NPC), listOf(STRING)),

        _6800(listOf(), listOf(STRING)),
        _6801(listOf(), listOf(INT)),
        _6802(listOf(), listOf(INT)),
        _6850(listOf(), listOf(STRING)),
        _6851(listOf(), listOf(INT)),
        _6852(listOf(), listOf(INT)),
        _6853(listOf(), listOf(INT)),
        
        _6900(listOf(), listOf(STRING)),
        _6950(listOf(), listOf(INT)),
        
        _7000(listOf(INT, INT, INT, INT, INT), listOf()),
        _7001(listOf(NPC_UID, INT, INT), listOf()),
        _7002(listOf(NPC_UID, INT, INT), listOf()),
        _7003(listOf(INT, INT), listOf()),
        _7004(listOf(INT), listOf()),
        _7005(listOf(INT, INT, INT, INT, INT), listOf()),
        _7006(listOf(INT, INT), listOf()),
        _7007(listOf(INT, INT), listOf()),
        _7008(listOf(INT), listOf()),
        _7009(listOf(INT), listOf()),
        _7010(listOf(INT, INT, INT, INT, INT), listOf()),
        _7011(listOf(INT, INT, INT, INT), listOf()),
        _7012(listOf(INT, INT, INT, INT), listOf()),
        _7013(listOf(INT, INT, INT), listOf()),
        _7014(listOf(INT), listOf()),
        _7015(listOf(INT, INT, INT, INT, INT), listOf()),
        _7016(listOf(INT, INT), listOf()),
        _7017(listOf(INT, INT), listOf()),
        _7018(listOf(INT), listOf()),
        _7019(listOf(INT), listOf()),
        _7020(listOf(INT, INT, INT, INT, INT), listOf()),
        _7021(listOf(INT, INT, INT, INT), listOf()),
        _7022(listOf(INT, INT, INT, INT), listOf()),
        _7023(listOf(INT, INT, INT), listOf()),
        _7024(listOf(INT), listOf()),
        _7025(listOf(INT, INT, INT, INT, INT), listOf()),
        _7026(listOf(INT, INT), listOf()),
        _7027(listOf(INT, INT), listOf()),
        _7028(listOf(INT), listOf()),
        _7029(listOf(INT), listOf()),
        _7030(listOf(INT, INT, INT, INT, INT), listOf()),
        _7031(listOf(STRING, INT), listOf()),
        _7032(listOf(STRING, INT), listOf()),
        _7033(listOf(STRING, INT), listOf(INT)),
        _7034(listOf(INT), listOf()),
        _7035(listOf(INT, INT, INT, INT, INT), listOf()),
        _7036(listOf(INT, INT, INT), listOf()),
        _7037(listOf(INT, INT, INT), listOf()),
        _7038(listOf(INT, INT), listOf()),

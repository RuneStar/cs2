...
interface Op {
    ...
    private enum class Basic(val args: Array<Arg> = emptyArray(), val defs: Array<Arg> = emptyArray()) : Op {
        ...
        _200(arrayOf(INT u S, INT u S, BOOLEAN u O), arrayOf(INT u S)),
        _201(arrayOf(INT u S, BOOLEAN u O), arrayOf(INT u S)),
        ...
        _1350(arrayOf(INT u S, INT u S, INT u S, INT u S, INT u S, INT u S, INT u S, INT u S, INT u S, INT u S, INT u S, BOOLEAN u O)),
        _1351(arrayOf(INT u S, INT u S, BOOLEAN u O)),
        _1352(arrayOf(INT u S, INT u S, INT u S, BOOLEAN u O)),
        _1353(arrayOf(INT u S, INT u S, BOOLEAN u O)),
        _1354(arrayOf(INT u S, BOOLEAN u O)),
        _1355(arrayOf(BOOLEAN u O)),
        ...
        _1505(arrayOf(BOOLEAN u O), arrayOf(INT u S)),
        ...
        _1611(arrayOf(BOOLEAN u O), arrayOf(INT u S)),
        ...
        _3109(arrayOf(INT u S, INT u S, BOOLEAN u O)),

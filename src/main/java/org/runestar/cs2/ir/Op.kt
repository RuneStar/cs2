...
import org.runestar.cs2.Type.INT
import org.runestar.cs2.Type.STRING
...
interface Op {
    ...
    private enum class Basic(val args: Array<Arg> = emptyArray(), val defs: Array<Arg> = emptyArray()) : Op {
        ...
        IF_SETPOSITION(arrayOf(INT u S, INT u S, INT u S, INT u S, INT u S)),
        IF_SETSIZE(arrayOf(INT u S, INT u S, INT u S, INT u S, INT u S)),
        IF_SETHIDE(arrayOf(INT u S, INT u S)),
        _2005(arrayOf(INT u S, INT u S)),
        _2006(arrayOf(INT u S, INT u S)),

        IF_SETSCROLLPOS(arrayOf(INT u S, INT u S, INT u S)),
        IF_SETCOLOUR(arrayOf(INT u S, INT u S)),
        IF_SETTRANS(arrayOf(INT u S, INT u S)),
        IF_SETLINEWID(arrayOf(INT u S, INT u S)),
        IF_SETGRAPHIC(arrayOf(INT u S, INT u S)),
        IF_SET2DANGLE(arrayOf(INT u S, INT u S)),
        IF_SETTILING(arrayOf(INT u S, INT u S)),
        IF_SETMODEL(arrayOf(INT u S, INT u S)),
        IF_SETMODELANGLE(arrayOf(INT u S, INT u S, INT u S, INT u S, INT u S, INT u S, INT u S)),
        IF_SETMODELANIM(arrayOf(INT u S, INT u S)),
        IF_SETMODELORTHOG(arrayOf(INT u S, INT u S)),
        IF_SETTEXT(arrayOf(INT u S, STRING u S)),
        IF_SETTEXTFONT(arrayOf(INT u S, INT u S)),
        IF_SETTEXTALIGN(arrayOf(INT u S, INT u S, INT u S, INT u S)),
        IF_SETTEXTANTIMACRO(arrayOf(INT u S, INT u S)),
        IF_SETOUTLINE(arrayOf(INT u S, INT u S)),
        IF_SETGRAPHICSHADOW(arrayOf(INT u S, INT u S)),
        IF_SETVFLIP(arrayOf(INT u S, INT u S)),
        IF_SETHFLIP(arrayOf(INT u S, INT u S)),
        IF_SETSCROLLSIZE(arrayOf(INT u S, INT u S, INT u S)),
        _2121(arrayOf(INT u S)),
        _2122(arrayOf(INT u S, INT u S)),
        _2123(arrayOf(INT u S, INT u S)),
        _2124(arrayOf(INT u S, INT u S)),
        _2125(arrayOf(INT u S, INT u S)),
        _2126(arrayOf(INT u S, INT u S)),
        _2127(arrayOf(INT u S, INT u S)),

        IF_SETOBJECT(arrayOf(INT u S, INT u S, INT u S)),
        IF_SETNPCHEAD(arrayOf(INT u S, INT u S)),
        IF_SETPLAYERHEAD_SELF(arrayOf(INT u S)),
        IF_SETOBJECT_NONUM(arrayOf(INT u S, INT u S, INT u S)),
        IF_SETOBJECT_ALWAYS_NUM(arrayOf(INT u S, INT u S, INT u S)),

        IF_SETOP(arrayOf(INT u S, INT u S, STRING u S)),
        IF_SETDRAGGABLE(arrayOf(INT u S, INT u S, INT u S)),
        IF_SETDRAGGABLEBEHAVIOR(arrayOf(INT u S, INT u S)),
        IF_SETDRAGDEADZONE(arrayOf(INT u S, INT u S)),
        IF_SETDRAGDEADTIME(arrayOf(INT u S, INT u S)),
        IF_SETOPBASE(arrayOf(INT u S, STRING u S)),
        IF_SETTARGETVERB(arrayOf(INT u S, STRING u S)),
        IF_CLEAROPS(arrayOf(INT u S)),

        IF_GETX(arrayOf(INT u S), arrayOf(INT u S)),
        IF_GETY(arrayOf(INT u S), arrayOf(INT u S)),
        IF_GETWIDTH(arrayOf(INT u S), arrayOf(INT u S)),
        IF_GETHEIGHT(arrayOf(INT u S), arrayOf(INT u S)),
        IF_GETHIDE(arrayOf(INT u S), arrayOf(INT u S)),
        _2505(arrayOf(INT u S), arrayOf(INT u S)),

        IF_GETSCROLLX(arrayOf(INT u S), arrayOf(INT u S)),
        IF_GETSCROLLY(arrayOf(INT u S), arrayOf(INT u S)),
        IF_GETTEXT(arrayOf(INT u S), arrayOf(STRING u S)),
        IF_GETSCROLLWIDTH(arrayOf(INT u S), arrayOf(INT u S)),
        IF_GETSCROLLHEIGHT(arrayOf(INT u S), arrayOf(INT u S)),
        IF_GETMODELZOOM(arrayOf(INT u S), arrayOf(INT u S)),
        IF_GETMODELANGLE_X(arrayOf(INT u S), arrayOf(INT u S)),
        IF_GETMODELANGLE_Z(arrayOf(INT u S), arrayOf(INT u S)),
        IF_GETMODELANGLE_Y(arrayOf(INT u S), arrayOf(INT u S)),
        IF_GETTRANS(arrayOf(INT u S), arrayOf(INT u S)),
        _2610(arrayOf(INT u S), arrayOf(INT u S)),
        _2611(arrayOf(INT u S), arrayOf(INT u S)),
        _2612(arrayOf(INT u S), arrayOf(INT u S)),
        _2613(arrayOf(INT u S), arrayOf(INT u S)),
        _2614(arrayOf(INT u S), arrayOf(INT u S)),

        IF_GETINVOBJECT(arrayOf(INT u S), arrayOf(INT u S)),
        IF_GETINVCOUNT(arrayOf(INT u S), arrayOf(INT u S)),
        IF_GETID(arrayOf(INT u S), arrayOf(INT u S)),
        _2706(defs = arrayOf(INT u S)),

        IF_GETTARGETMASK(arrayOf(INT u S), arrayOf(INT u S)),
        IF_GETOP(arrayOf(INT u S, INT u S), arrayOf(STRING u S)),
        IF_GETOPBASE(arrayOf(INT u S), arrayOf(STRING u S)),
        ...
        override fun translate(state: Interpreter.State): Insn {
            ...
            for (def in defs) {
                when (def.src) {
                    S -> {
                        exprDefs.add(state.push(def.type))
                    }

...
internal interface Op {
    ...
    private enum class Basic(val args: Array<Arg> = emptyArray(), val defs: Array<Arg> = emptyArray()) : Op {
        ...
        CHAT_GETHISTORY_BYTYPEANDLINE(arrayOf(CHATTYPE u S, INT u S), arrayOf(INT u S, INT u S, INT u S, STRING u S, STRING u S, STRING u S)),
        CHAT_GETHISTORY_BYUID(arrayOf(INT u S), arrayOf(CHATTYPE u S, INT u S, INT u S, STRING u S, STRING u S, STRING u S)),
        ...
        CHAT_GETHISTORYLENGTH(arrayOf(CHATTYPE u S), arrayOf(INT u S)),

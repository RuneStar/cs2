...
interface Op {
    ...
    private enum class Basic(val args: Array<Arg> = emptyArray(), val defs: Array<Arg> = emptyArray()) : Op {
        ...
        _6600(),
        WORLDMAP_GETMAPNAME(arrayOf(INT u S), arrayOf(STRING u S)),
        WORLDMAP_SETMAP(arrayOf(INT u S)),
        WORLDMAP_GETZOOM(defs = arrayOf(INT u S)),
        WORLDMAP_SETZOOM(arrayOf(INT u S)),
        WORLDMAP_ISLOADED(defs = arrayOf(BOOLEAN u S)),
        WORLDMAP_JUMPTODISPLAYCOORD(arrayOf(INT u S)),
        WORLDMAP_JUMPTODISPLAYCOORD_INSTANT(arrayOf(INT u S)),
        WORLDMAP_JUMPTOSOURCECOORD(arrayOf(INT u S)),
        WORLDMAP_JUMPTOSOURCECOORD_INSTANT(arrayOf(INT u S)),
        WORLDMAP_GETDISPLAYPOSITION(defs = arrayOf(INT u S, INT u S)),
        WORLDMAP_GETCONFIGORIGIN(arrayOf(INT u S), arrayOf(INT u S)),
        WORLDMAP_GETCONFIGSIZE(arrayOf(INT u S), arrayOf(INT u S, INT u S)),
        ...
        WORLDMAP_FLASHELEMENTCATEGORY(arrayOf(INT u S)),
        ...
        WORLDMAP_DISABLEELEMENTCATEGORY(arrayOf(INT u S, INT u S)),
        ...
        MEC_CATEGORY(arrayOf(INT u S), arrayOf(INT u S)),

...
internal interface Op {
    ...
    private enum class Basic(
        ...
        WORLDMAP_PERPETUALFLASH(arrayOf(BOOLEAN), arrayOf()),
        ...
        WORLDMAP_LISTELEMENT_START(arrayOf(), arrayOf(MAPELEMENT, Type.COORD)),
        WORLDMAP_LISTELEMENT_NEXT(arrayOf(), arrayOf(MAPELEMENT, Type.COORD)),
        MEC_TEXT(arrayOf(MAPELEMENT), arrayOf(STRING)),
